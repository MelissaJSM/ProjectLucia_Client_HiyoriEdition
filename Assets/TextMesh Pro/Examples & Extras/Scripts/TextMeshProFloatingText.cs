...
namespace TMPro.Examples
{
    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                //if(SettingData.IsDebug) Debug.Log("Spawning TextMesh Objects.");
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                if (current_Count <= 3)
                {
                    //if(SettingData.IsDebug) Debug.Log("Fading Counter ... " + current_Count.ToString("f2"));
            ...
            //if(SettingData.IsDebug) Debug.Log("Done Counting down.");
        ...
        public IEnumerator DisplayTextMeshFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                //if(SettingData.IsDebug) Debug.Log("Current Count:" + current_Count.ToString("f2"));
