...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    // if(SettingData.IsDebug) Debug.Log("Link ID: \"" + linkInfo.GetLinkID() + "\"   Link Text: \"" + linkInfo.GetLinkText() + "\""); // Example of how to retrieve the Link ID and Link Text.
        ...
        {
            //if(SettingData.IsDebug) Debug.Log("OnPointerEnter()");
        ...
        {
            //if(SettingData.IsDebug) Debug.Log("OnPointerExit()");
        ...
        {
            //if(SettingData.IsDebug) Debug.Log("Click at POS: " + eventData.position + "  World POS: " + eventData.worldPosition);
            ...
            if (charIndex != -1 && charIndex != m_lastIndex)
            {
                //if(SettingData.IsDebug) Debug.Log("Character [" + m_TextMeshPro.textInfo.characterInfo[index].character + "] was selected at POS: " + eventData.position);
                m_lastIndex = charIndex;
            ...
            */
            ...
            if (linkIndex != -1)
            {
                ...
                //if(SettingData.IsDebug) Debug.Log(TMP_TextUtilities.GetSimpleHashCode("id_02"));
        ...
        {
            //if(SettingData.IsDebug) Debug.Log("OnPointerUp()");
        }
