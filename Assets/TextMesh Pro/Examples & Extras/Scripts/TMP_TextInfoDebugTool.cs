            ...
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //if(SettingData.IsDebug) Debug.Log("Start Word Region at [" + currentCharInfo.character + "]");
                        ...
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //if(SettingData.IsDebug) Debug.Log("End Word Region at [" + currentCharInfo.character + "]");
                        }
                    }
                ...
                //if(SettingData.IsDebug) Debug.Log(wInfo.GetWord(m_TextMeshPro.textInfo.characterInfo));
            }
